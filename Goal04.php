...
$video_file_name = "Goal04_video_list";
...
<div id="inner">
    ...
    <main id="main_contents">
      <img id="main_visual" src="./images/Goal04long.png">
      <h1>
        4. 質の高い教育をみんなに
      </h1>
      <p>
      ...
      <section style="overflow:scroll;">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/uZhmt0EDB90" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </section>
...
<section id="member_video_list" style="border-top: ridge rgba(0, 0, 155, .6);border-bottom: ridge rgba(0, 0, 155, .6);">
  ...
  foreach ($SDGs_member_video_list as $video_no => $video_item) {
    ...
    $key = in_array("Goal04", $SDGs_Goals);
    if ($key == false) {
      continue;
    }
