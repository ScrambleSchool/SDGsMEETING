...
$video_file_name = "Goal06_video_list";
...
<div id="inner">
    ...
    <main id="main_contents">
      <img id="main_visual" src="./images/Goal06long.png">
      <h1>
        6. 安全な水とトイレを世界中に
      </h1>
      <p>
      ...
      <section style="overflow:scroll;">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/DcJWyoweEY4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/7arYLTbzTuM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/316Dl4vuJ8U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </section>
...
<section id="member_video_list" style="border-top: ridge rgba(0, 0, 155, .6);border-bottom: ridge rgba(0, 0, 155, .6);">
  ...
  foreach ($SDGs_member_video_list as $video_no => $video_item) {
    ...
    $key = in_array("Goal06", $SDGs_Goals);
    if ($key == false) {
      continue;
    }
